...
public class DuplicatiAttributi implements Attributi_itf, Serializable, Cloneable {

    private static final long      serialVersionUID = -8391886038053908664L;
    private FileInfoExt            _fi              = null;

    public static final String[]   COLUMN_NAMES     = { "Selezionato", "Gruppo", "Stato Gruppo", "Folder name",
            "File name", "Dimensione", "Ultima modifica", "Regola" };

    public static final Class<?>[] COLUMN_CLASSES   = { Boolean.class, Integer.class, GroupState.class, String.class,
            String.class, Integer.class, Date.class, Integer.class };

    public DuplicatiAttributi() {
