...
public class RegolaDettaglio implements ActionListener {
    ...
    private JTextField        _jtfDimMin       = null;
    private JTextField        _jtfDimMax       = null;
    ...
    public RegolaDettaglio(RegolaAttributi attibuti) {
    ...
    public Component showComponent(Window owner) {
        ...
        _jtfPercorso = new JTextField(10);
        ...
        _jtfDimMin = new JTextField(10);
        _jtfDimMin.setText(String.valueOf(_attributi.getDimMin()));
        pRValues.add(_jtfDimMin);
        _jtfDimMax = new JTextField(10);
        _jtfDimMax.setText(String.valueOf(_attributi.getDimMax()));
    ...
    public void actionPerformed(ActionEvent actionevent) {
        ...
        if (eventSource.equals(_bRAOk)) {
            ...
            try {
                _attributi.setDimMin(Long.parseLong(_jtfDimMin.getText()));
            } catch (NumberFormatException nfe) {
            }
            try {
                _attributi.setDimMax(Long.parseLong(_jtfDimMax.getText()));
            } catch (NumberFormatException nfe) {
            }
