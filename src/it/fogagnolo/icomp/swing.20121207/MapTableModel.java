...
/*
 * da http://www.java2s.com/Tutorial/Java/0240__Swing/MapTableModel.htm
 *
...
public class MapTableModel extends AbstractTableModel {
    ...
    private static final long serialVersionUID = 5021117954725532346L;
...
//    }
    ...
    public Object getValueAt(int row, int column) {
        ...
        if (column == 0) {
            ...
            throw new IndexOutOfBoundsException("MapTableModel provides a 2-column table, column-index " + column
                    + " is illegal.");
        }
    }
